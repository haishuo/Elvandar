...
**"The other thing" — CLOSED, and the phrase is deliberately *not* reserved.**

Inventory. Take-over uses: B1 ch18 (the healer), B2 ch11 (Rosik's sight), B2 ch8 (**Kalden's** — *"the thing that came up fast and cold when the prince was wounded"*). Plain idiom: B2 ch4 ×2, ch9, ch10.

Reserving was considered and rejected on three grounds. **One:** the Kalden instance sits in B2 ch8, which is on the do-not-touch list, so reserving properly means either editing the best chapter in the series or accepting a permanent exception in it. **Two:** Book 2 has had no editorial changes applied at all, and spending the first four on a phrase is bad economy. **Three:** the rhyme that matters already exists at the only two places it needs to — B1 ch18 and B2 ch11 — and ch11 already draws the contrast explicitly. It does not need reinforcing; it needs not to be diluted.

Standing note: *the other thing* is plain idiomatic English, it will keep wanting to appear across six more books, and a phrase this ordinary would likely read as mild repetition rather than as a connection. **Do not attempt to reserve it later.**

**Applied:** the ch1 instance — *"because that was the other thing he had never been able to stop doing"* — cut entirely. It was introduced during this review pass, not authorial; it was the weakest of the three (a habit, not a seizure of control); and it sat closest to the reader's first exposure. A rename was rejected too — the obvious candidate, *"the way he always did,"* collides with B1 ch18's *"the way it always did."* The cut also removes a third statement of involuntariness in a chapter that already has two (*"before he knew he'd chosen them"*, *"without deciding to"*), and the three sentence-fragments that follow already **are** the arithmetic.
...
them. All three have since been applied and closed.*

**None outstanding.** C-12 through C-15 were re-verified and closed; C-20, C-21 and C-22 were opened
in their place and all three are applied. Book 2's craft list is empty for the first time.
...
the closed-items table. **C-20 was then applied — the first editorial change ever made to Book 2.**
C-21 and C-22 remain open and unproposed.
...
**C-20 — the verdict-stamp habit. APPLIED.**
