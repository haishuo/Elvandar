# Story Timeline (Character & Plot Scale)

Companion to [Global Historical Timeline.md](Global%20Historical%20Timeline.md) (world history, in Balishan Reckoning / **BR**). *This* doc covers the **recent, character-scale chronology** so ages and durations stay consistent chapter to chapter.
...
> stood in the east hall and could not make himself speak has to stay a boy. Elara remains 20 (locked by ch6 prose,
...
## Locked by Book 1 PROSE (do not contradict)
...
- **Keep House Darfi leashed** — deploying the sworn vassal's "useful daughter" is the leverage working as designed.
- **Angle for a controllable daughter-in-law** — a Farleen–Silvanno match would bind the vassal tighter and give Tania an in-law who owes everything to Larannas.
- **Reassure the Coterie** the little group is no real threat.

Farleen's method with Silvanno was seduction; Silvanno — savvy, and trained by Tania herself to read exactly this game — didn't bite, and kept her at arm's length **without ever making her as a spy** (which is why Xion is blindsided by her confession in Book 1 ch4). Farleen reported the miss, stayed embedded, and **redirected to Xion**, judging her odds better there; Tania — disappointed about the match but pragmatic, since Xion and Silvanno are inseparable — kept the asset and approved the pivot. It began as pure manipulation; then Farleen got to know Xion and **genuinely fell for him** (which gives a spine to the Xion–Farleen intimacy Book 1 implies). **The five years are what make this work.** Feelings that real do not develop on a six-month assignment, and neither does the trust she has to betray; five years is also the only span on which Tania plausibly leaves an asset in place, and on which Farleen's steady stream of "harmless" reports reads as a habit of protection rather than a single lie. Her reports downplaying the group as "harmless" (Book 1 canon) end up serving Tania *and* shielding the people she was sent to watch — the same lie doing both. *(No blood issue: House Darfi is ~20 years old, founded by Farleen's father; zero relation to House Larannas.)*
| **1044** | **23** | **Book 1.** Sees Elara in the market; ~4 days of investigation; the compound; Farleen's knife; the Warrens & Brass Door; Sa Ko Ren's trial; coronation. *Book 1's action ≈ 1 month.* |
| 1044 | 23 | **Book 2** begins ~2–3 weeks post-coronation. |

---

## Book 2: *The One You Feed* (1044 BR) — flexible (unpublished)

Spans **~5 months**, coronation → Rosik's exile. Chapter timings (from beat drafts):
...
| Ch2 Letters | Wk 3–4 |
| Ch3 Thirst | Wk 4–5 |
| Ch4 Nonessential | **Wk 7–8** |
| … → Rosik's exile | ~Wk 22 |

At Ch4 it has been **~3 months** since Xion first found Elara. **The whole saga so far measures in months — never "years."**
