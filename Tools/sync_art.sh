#!/usr/bin/env bash
# Sync this repository's raster images to and from Backblaze B2.
#
# Images are not tracked in git — see CLAUDE.md §7 and .gitignore. B2 is the durable
# copy; the local folder is the working copy the Elvandar Viewer reads. This script
...
REMOTE="writing:haishuo-writing-images/elvandar"
