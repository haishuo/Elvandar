...
# Names — the series register

Every named person in Elvandar, Books 1–8, with the book span and one line on who they are.
Built 2026-08-04 from a full sweep of `Book */Chapters/`, `Book */Beat Drafts/`, the Books 4–8
...
**Before coining a name:** find the book it appears in below, list the initials already spoken in
...
| **Sela** | 2 | Saved by Xion in ch3 |
| **Deshan** | 2 | On the gate; one of the friendly ones |
| **Deshi** | 3 | Warrens figure; named in Ronas's dialogue |
...
Both look like bugs in a census and neither is. Recorded here so they are not "discovered"
later and fixed by someone doing the right thing for the wrong reason.

**Two Melinas.** *Melina Kemvimore* dies in Book 2; *Melina Valanar* is Xion and Elara's
daughter, born after. She is named for his sister. The repetition is the point and the register
is identical because it would be.

**Two Issamils, one letter apart.** *Kai* is *Kael's* son, and the sheet builds the parallel
deliberately — the same Paradigm stack with one modification, the same partnership shape a
generation on. **This is the one live hazard in the register:** they overlap in Books 5 and 6, a
father and son will share sentences, and *Kael/Kai* differ in one syllable's coda, which is the
