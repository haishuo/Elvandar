...
**Purpose:** Provide access routes for workers maintaining the ventilation and water systems.
...
* Width: 4-6 meters  
* Designed for mass movement of people  
* Clearest, most direct routes between depths  
* Multiple redundant routes from different city sections  
* Wide staircases and ramps (in addition to elevators)  
* Emergency lighting systems (some still function)
...
**Large Waystations (40-60 meters diameter):**

* Major hubs where multiple tunnel types intersected  
* Worker dormitories for maintenance crews on long shifts  
* Equipment depots storing heavy machinery  
* Monitoring stations with status displays for all systems  
* Break rooms and communal areas  
* Connected to multiple tunnel types for easy access

**Medium Waystations (20-35 meters):**

* Team stations for 10-20 workers  
* Local equipment storage  
* Rest stops on long journeys  
* Minor monitoring stations

**Small Waystations (8-15 meters):**

* Individual worker stations  
* Equipment caches  
* Emergency shelters  
...
**True Nature:** The "door" is actually a massive circular gear that rotates into the wall. When unlocked, it spins smoothly into a recess, revealing the passage beyond. The gear-door weighs several tons but moves effortlessly on ancient bearings still perfectly maintained by self-repair systems.
...
* Diameter: 100 meters  
* Extends through all seven levels  
* Contains mechanical elevators (still functional)  
* Primary transportation between levels  
...
**Depth:** \-700 to \-850 meters below surface  
 **Diameter:** \~3 kilometers  
 **Designed Population:** \~100,000

**Purpose:** Administrative center, diplomatic quarter, and surface interface.
...
**Current State:** Perfectly preserved. The rotating mechanism still functions—the entire level slowly turns on its massive gears. Lights remain active, temperature controlled. It appears the residents simply vanished mid-activity.

### **Level 2: The Athenaeum (Knowledge District)**

**Depth:** \-850 to \-1,000 meters  
 **Diameter:** \~2.5 kilometers  
 **Designed Population:** \~80,000

**Purpose:** Educational institutions, libraries, research centers (non-magical).

**Districts:**

* **The Great Library:** Largest collection of knowledge in ancient world  
* **The Universities:** Multiple institutions of higher learning  
* **The Observatory:** Astronomical research (using magical scrying, not telescopes)  
* **The Natural History Museum:** Specimens from across Elvandar  
* **The Student Quarter:** Dormitories and social spaces

**Architecture:** Focused on function—clear sight lines, excellent acoustics for lectures, bright lighting for reading. More austere than The Crown but beautifully proportioned.
...
* **The Noble Quarters:** Wealthy elven families  
* **The Scholar Towers:** Housing for academics and researchers  
* **The Artisan District:** Craftspeople and their workshops  
* **The Markets:** Commercial centers and trading posts  
* **The Commons:** Public gathering spaces, parks, fountains
...
### **Level 4: The Forge (Manufacturing District)**

**Depth:** \-1,150 to \-1,300 meters  
 **Diameter:** \~2 kilometers  
 **Designed Population:** \~70,000

**Purpose:** Industrial manufacturing, crafting, and production.

**Districts:**

* **The Foundries:** Metalworking and forging  
* **The Artificers' Workshops:** Magi-tech device construction  
* **The Textile Mills:** Fabric production  
* **The Warehouses:** Storage and distribution  
* **The Innovation Quarter:** Experimental manufacturing

**Architecture:** Utilitarian but elegant. High ceilings for ventilation, reinforced floors for heavy equipment, wide passages for material transport. Even functional spaces show artistic sensibility.

**Materials:** Heavy brass and steel. Exposed gears and mechanisms as decorative elements. Strong, durable construction.

**Current State:** Forges cold. Assembly lines frozen. Half-finished magi-tech devices sit on workbenches. The machinery of civilization stopped mid-production.

### **Level 5: The Arcanum (Magical Research)**

**Depth:** \-1,300 to \-1,500 meters  
 **Diameter:** \~1.5 kilometers  
 **Designed Population:** \~50,000

**Purpose:** Magical research, experimentation, and theoretical development.

**Districts:**

* **The Spire Laboratories:** Individual research towers for senior mages  
* **The Experimental Grounds:** Testing fields for new spells  
* **The Containment Vaults:** Secured storage for dangerous magical items  
* **The Theoretical Institute:** Pure magical research  
* **The Binding Circles:** Summoning and planar research

**Architecture:** Strange and beautiful. Towers that seem to defy gravity. Chambers where geometry itself appears non-euclidean. Spaces designed to contain and channel enormous magical energies.

**Materials:** Crystal, enchanted metals, materials that shift color in response to ambient magic. Many surfaces inscribed with protective runes.

**Current State:** Still humming with latent magical energy. Some experiments remain active—containment fields holding nothing, scrying pools showing static, protective wards powered by the Core. The most dangerous level to explore.

### **Level 6: The Repository (The Great Library of Truth)**

**Depth:** \-1,500 to \-1,700 meters  
 **Diameter:** \~1 kilometer  
 **Designed Population:** \~10,000 (scholars and guardians only)

**Purpose:** A magical repository containing vast amounts of recorded knowledge and information.

**The Repository Chamber:** A vast spherical chamber (500 meters diameter) containing the Repository apparatus—a complex magical construct where information exists as accessible data.

**Architecture:** Single enormous chamber surrounded by smaller study rooms and preparation chambers. The main chamber features platforms at multiple heights, all focused on the central Repository construct.

**Materials:** Pure crystal and enchanted brass. The walls themselves serve as information storage. Glowing conduits connect everything to the central apparatus.

**Access Requirements:** Requires specific magical attunement and training. Not everyone could safely access the Repository—untrained minds could be overwhelmed by the information transfer process.

**Current State:** Still active. The Repository remains functional, its systems powered by the Core below. The magical construct pulses with soft light, waiting.

### **Level 7: The Core (Power Generation)**

**Depth:** \-1,700 to \-2,000 meters  
 **Diameter:** \~500 meters  
...
* Even weight distribution (prevents structural stress)  
* Symbolic (the gears of fate turning)  
* Practical (allows reconfiguration of city layout through rotation)

**Engineering:**

* Each level's floor is a massive circular platform  
* Platform sits on thousands of precision bearings  
* Driven by ring gears around the perimeter  
* Power delivered through central shaft  
* Perfectly balanced to minimize energy requirements

**Current State:** Still rotating. The gears turn smoothly, perfectly balanced, perfectly maintained by automated systems. The rotation has continued uninterrupted for 5,000 years.

### **Elevator System**

**The Central Shaft Elevators:**

* Multiple elevator platforms on tracks in the central shaft  
...
* Platforms: 10 meters diameter  
* Capacity: 20-30 people or equivalent cargo  
* Speed: Variable based on distance traveled  
* Safety systems: Multiple redundant brakes and emergency stops

**Current State:** Waiting. The elevators remain at their last positions, ready to move when called. Control systems active, power available.
...
* Monitoring systems detect problems and dispatch solutions  
* All powered by the geothermal Core

**How They Work:**

* Sensors throughout the city detect issues  
* Central control systems evaluate and prioritize  
* Appropriate constructs are activated and dispatched  
...
* Cannot repair major structural damage  
* Organic materials (wood, fabric, plants) have decayed despite efforts  
* Some systems have failed over time (no construct can last forever)  
...
7. Access the entire city from there

**Total Travel Time:** With perfect knowledge and no obstacles: 10-14 hours from surface to The Crown.
...
* Dead Man's Passage can be navigated (they have the map)  
* A brass door exists at the end  
* The door is sealed (they cannot open it)  
* Something important lies beyond
...
* Self-repair systems (maintaining everything)  
* The Repository (powered and active)  
* Core power systems (fully operational)
...
* Architecture: Perfectly preserved  
