...
### The transition was never the prose. The chapter boundary was in the wrong place.

**Author, for the third time and after a full from-scratch rewrite: *"I still can't see it."*** Printing the
two chapters' raw join side by side made it obvious in about ten seconds, and it explains why three rounds
of line-editing never touched it.

**Ch6's last scene was ch7's opening.** The camp goes in over nine days; the Tor'anar arrive on the fourth
day; by the ninth day there is light; **and then the Urathans come down.** That is one continuous run, and
the chapter break was sitting in the middle of it. Which produced, unavoidably:

- **Ch6 ended on a lull** — everything built, nobody doing anything, no forward pull.
- **Ch7 restarted the same scene** in the same room with new arrivals.
- **An unattached pronoun in ch7's first line** — *"They came down"* — because ch6 deliberately does not
  name the Urathans. **The fourth referent-with-nothing-behind-it in this chapter's history**, and the
  first one caused by structure rather than by a sentence.
- **The Door and the chamber described twice**, four paragraphs apart, across the break.

**Ch6 now ends where its argument ends:** the climb-out, the record saying what it says, *"Well." "You got
it." "I got it."* — and he does not say the rest of it to her, or to Elara that night, or to anybody, and
nobody says it to him. **That is the correct last beat for a chapter about what things cost**, and it is
colder than ending on an inventory.

**Ch7 now opens on the camp going in** and runs unbroken: nine days of labour → the Urathans come down on
the tenth morning → three weeks of the Door doing nothing → the Door turns → Lathion. **The *nothing*
motif now beats three times inside one chapter** — *the Door at the end of it, doing what it had been doing
… which was nothing* / *Then they went to work, and the Door did nothing* / *It went on doing nothing for
a long time* — where before it was split across a boundary and lost its rhythm entirely.

**The lesson, and it is expensive enough to be worth stating flatly.** Three separate passes were spent
rewriting sentences on either side of a join, including one complete from-scratch rewrite of a chapter
that was not the problem. **When a transition still fails after the prose on both sides has been fixed,
stop editing the prose and ask whether the break is in the right place.** The tell was available from the
first complaint: both chapters had the same setting, the same furniture, and the same cast, and nothing
changed across the break except that some people arrived.

**Knock-on fixed in the same pass:** *eleven* was carrying eleven days, eleven pages and eleven scholars
across three chapters, so the Urathan contingent is now **twelve**. Ch6 5,443 → **5,212**; ch7 3,053 →
**3,283**. Zero six-gram collisions across the seam. Both beat drafts and the skeleton entry moved with the
boundary in the same commit, and the ch6 draft carries a footer recording why the chapter stops where it
now stops.
